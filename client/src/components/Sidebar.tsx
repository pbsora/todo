...
const Sidebar = () => {
  return (
    <div className="h-screen text-white bg-black w-[100vw] md:w-[7vw] xl:w-[5vw] flex flex-col items-center gap-8">
      ...
      <div id="side-main" className="flex flex-col flex-1 gap-6 text-4xl">
        <div className="icon group">
          <FaTasks />
          <span className="sidebar-tooltip group-hover:scale-100">Todos</span>
        </div>
        <div className="icon group">
          <AiFillProject />
          <span className="sidebar-tooltip group-hover:scale-100">
